        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinLoanAmount = table.Column<int>(type: "int", nullable: false),
                    LockIn = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankRates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BankRates_Banks_BankId",
                        column: x => x.BankId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "char(36)", nullable: false),
                    EnquiryCode = table.Column<int>(type: "int", nullable: false),
                    LoanType = table.Column<int>(type: "int", nullable: false),
                    PropertyType = table.Column<int>(type: "int", nullable: false),
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    RecommendedBankIds = table.Column<string>(type: "longtext", nullable: false),
                    ExistingBankId = table.Column<Guid>(type: "char(36)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enquiries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Enquiries_Banks_ExistingBankId",
                        column: x => x.ExistingBankId,
                        principalTable: "Banks",
                        principalColumn: "Id");
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankRates_BankId",
                table: "BankRates",
                column: "BankId");

            migrationBuilder.CreateIndex(
                name: "IX_Enquiries_ExistingBankId",
                table: "Enquiries",
                column: "ExistingBankId");
        }
